    ...
    describe('YEventEmitter', function () {
        ...
        describe('on()', function () {
            ...
            it('should throw error if callback is not a function', function () {
                getWrongCallbacks().forEach(function (callback) {
                    (function () {
                        emitter.on('event', callback);
                    }).should.throw(Error, 'YEventEmitter#on(): `callback` must be a function.');
                });
            });
        });
        ...
        describe('once()', function () {
            ...
            it('should throw error if callback is not a function', function () {
                getWrongCallbacks().forEach(function (callback) {
                    ...
                    }).should.throw(Error, 'YEventEmitter#once(): `callback` must be a function.');
                });
            });
        });
        ...
        describe('off()', function () {
            ...
            it('should throw error if callback is not a function', function () {
                getWrongCallbacks().forEach(function (callback) {
                    ...
                    }).should.throw(Error, 'YEventEmitter#off(): `callback` must be a function.');
                });
            });
        });
